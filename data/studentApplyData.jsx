...
const faq = [
  {
    ...
    answer: (
      <>
        ...
        <p>
          <i>Community: </i> Join an organization with a strong focus on mentorship and social
          community events{' '}
        </p>
      </>
    ),
  ...
  {
    question: 'Is extensive web development or data science experience required?',
    answer:
  ...
  },
  {
    ...
    answer: (
      <>
        We would love to accept all of our good candidates, but from our perspective, this is what
        we see. <br />
        <br />
        <ul>
          <li>
            {' '}
            We can’t work with all the non-profits in the world, because the quality of work and
            projects is just not scalable. We need to be incredibly selective with our leads because
            any risk of wasting an entire six months of time would ultimately be counterproductive
            for both our clients and students.{' '}
          </li>
          <li>
            We can’t have enormous teams because productivity inherently goes down, and work becomes
            less meaningful if anyone is tasked with completing a miniscule part of the project. On
            top of that, there are physical limits on the number of groups we can meet in person.
          </li>
          <li>
            We can only interview a fixed number of candidates, no matter how many good ones apply.
            We can only take as many candidates as our projects leads can support along with the
            scope of the projects itself. We want to take everyone who is qualified and we want to
            take on more projects, but for the reasons above, we just can’t.
          </li>
        </ul>
        That being said, we are looking into ways we can accommodate for members in the future such
        as holding more external events and tech talks, expanding our interview process to interview
        more candidates, and increasing our training program for more Product Managers/Technical
        Leads to take on more projects but maintain the high quality work we are know for.
      </>
    ),
  },
  {
...
const studentProcess = [
  ...
  // },
  {
    ...
    detail: (
      <>
        <p>
          Keep in touch with us by following our social media. You can find recruitment updates on
          these platforms in addition to our website.
        </p>
        {
          <ActionButton
            style={{ display: 'block', marginTop: '10px' }}
...
const closedText = (
  <p>
    Our recruitment process has historically consisted of an Info Session and applications due in
    the first week of the semester and a behavioral interview, role-specific interview, and social
    round in the weeks to follow. Certain roles will also require a take home exercise to be
    completed. More information on roles and recruitment can be found on our{' '}
    <a href="https://www.notion.so/h4iuiuc/Join-Hack4Impact-UIUC-2e875ce396b34e6ebb23c6dda57a89aa">
      official Notion page
    </a>
    .<p></p>
