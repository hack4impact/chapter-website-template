...
export default {
  ...
  ngoProcess: [
    ...
    // },
    {
      ...
      detail: (
        <>
          Reach out to our team via <a href="mailto:uiuc@hack4impact.org">email</a> to get started
          with the application process. We'd love to hear more about your organization and potential
          project ideas as it will help us get an initial sense of your organization's goals, needs,
          and expectations while you progress through the application process.
        </>
      ),
      icon: <Contract />,
    },
    ...
    },
    {
      ...
      detail: (
        <>
          We will review the details for the finalized project and confirm that our goals and
          expectations are aligned. If everything checks out, our our project leads will contact you
  ...
  quote: {
    ...
    source: 'Kelly Wolfe',
    sourceTitle: 'Love Without Boundaries Managing Director of Strategic Partnerships',
  },
  faq: [
    {
      ...
      answer: (
        <>
          Each project has a Product Manager, who will be responsible for communicating with the
          client, leading the team, and delivering a successful product as well as a team of
          software engineers to build the technology. They will be leading a team of 5-8 developers
          with a possibility of a designer as well. They will start off diving even deeper into your
          idea and problems and come up with a Product Requirements Doc (PRD) specifying your
          requirements and timeline. Development will start shortly afterwards and they will
          maintain contact with you throughout the entire process to gather feedback. Notable dates
          will the Minimum Viable Product (MVP) demo, which will happen around the middle of the
          semester and the handoff, which will be around the end of the semester. For more
          information, look <a href="https://h4i-project-timeline-qonwikgcqk.now.sh">here.</a>
          <br />
          <br />
          Traditionally, projects and development will span one semester, after which our team will
          transfer ownership of the repository and any additional resources created during the
          development process. More recently, however, some projects have spanned the course of an
          entire year in an effort to ensure quality and impact. The development process follows the
          exact same structure in these cases, where a fully fully functional prototype is completed
          after one semester. However, these projects continue by gathering feedback during the next
          semester and iterating on the prototype to ensure that we're creating the most impactful
          and useful product for our clients. The length of the project is discussed and agreed upon
          from both parties before official development.
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      answer: (
        <>
          Tell us about your organization and the problems that you are facing. Let us know what
          your vision is and come in with some initial project project ideas. Don’t worry about the
          validity of those ideas - we use them as a starting point for deeper conversation
          regarding your organization during our initial call! While a detailed application would be
          helpful, we also have a very supportive team that will guide through our process and
          inform you of all the relevant information that we will need along the way.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          are the best examples! Some other examples include:
          <ul>
            <li>
            ...
            <li>
              An application that allows you to keep track of the organization's activities and see
              where cost cutting can occur.
            </li>
            <li>
              An application to keep track of the people you serve and better assess your overall
              impact.
            </li>
            <li>Or anything else that will empower you to broaden your impact!</li>
          </ul>
        </>
      ),
    },
  ...
  applicationDetail: (
    <>
      Our application process is designed to be as straightforward as possible. If you are
      interested in working with us, you can contact us at
      <a href="mailto:uiuc@hack4impact.org"> uiuc@hack4impact.org</a> with your organization and
      vision for the problems you are facing. We will carefully consider your submission and reach
      out to you if our goals goals align. Some aspects of potential projects that we pay close
      attention to include technical complexity, impact, and mission.
    </>
  ),
  closedApplicationText: (
    <b>
      Our current application period for {currentSemester} has closed! Feel free to reach out to us
      or fill in the
      <a href={interestFormLink}> non-profit interest form </a>
      and we’ll still love to talk to you and potentially work with your organization in{' '}
      {nextSemester}.
    </b>
  ),
};
